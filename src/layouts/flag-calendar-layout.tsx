...
export default function FlagCalendarLayout({
  ...props
  ...
  return (
    ...
    >
      ...
      {/* youbi and numeric year (middle middle) */}
      ...
      <div className="w-full h-full col-start-1 row-start-2 flex flex-col items-center">
        <div className="grow" />
      ...
      <div className="w-full h-full col-start-1 row-start-3 flex flex-col items-center">
        <div className="w-full grow bg-(--color-theme)" />
        <Copyright className="w-full text-(--color-theme)" />
      </div>

      {/* gradient and numeric date (right middle) */}
      <div className="w-full h-full col-start-3 row-start-2 flex flex-col text-(--color-theme)">
        <div className="relative w-full h-full font-extrabold overflow-hidden select-none">
          <svg
            viewBox="0 0 20 10"
            className="absolute h-[125%] left-0 bottom-0"
            preserveAspectRatio="xMinYMin meet"
            fill="currentColor"
          >
            <text
